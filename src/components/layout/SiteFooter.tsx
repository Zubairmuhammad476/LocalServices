...
export default function SiteFooter() {
  ...
  return (
    <>
      {/* ── SEO Link Matrix — white bg, above dark footer ────────────── */}
      <div className="bg-white border-t border-slate-100 py-10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <p className="text-[0.65rem] font-bold uppercase tracking-widest text-slate-400 mb-6">
            Explore Services Across UAE
          </p>
          <div className="grid grid-cols-2 gap-6 sm:grid-cols-4">
            {SEO_MATRIX.map((col) => (
              <div key={col.title}>
                <h4 className="mb-3 text-xs font-bold text-[#002366] uppercase tracking-wider">
                  {col.title}
                </h4>
